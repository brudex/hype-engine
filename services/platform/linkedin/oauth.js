...
/** Default OAuth scopes for connect + post (adjust if using OpenID Connect). */
const DEFAULT_SCOPE = 'r_liteprofile r_emailaddress w_member_social';
 ...
 * @param {string} [scope] - Optional scope string (default: r_liteprofile r_emailaddress w_member_social)
